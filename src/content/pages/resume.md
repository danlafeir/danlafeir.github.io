...
experience:
  - title: Senior Engineering Manager
    ...
    bullets:
      ...
      - "Led cross-team working sessions with EMs and Product managers using domain-driven design to align teams on ownership boundaries and reduce delivery friction."
  - title: Senior Staff Engineer
    ...
    bullets:
      ...
      - "Evaluated and selected Datadog On-Call by partnering with Datadog product leadership, then built onboarding materials with an engineering director to roll out on-call paging across the org."
  ...
  - title: Developer Consultant
    ...
    intro: "IC across 2 client engagements focused on GUI applications. Built a Vanilla JS interactive experience for the New York Philharmonic's Lincoln Portrait archive."
    bullets: []
technicalProficiencyText: "Confident writing JavaScript (TypeScript preferred), Go, Python, and Kotlin/Java with popular associated frameworks. Proficient with building software with AI. Experienced standing up Kubernetes clusters, CI/CD pipelines, and AWS infrastructure using Terraform and other IaC tools. Familiar with data engineering tools like Spark and Kafka."
skills:
